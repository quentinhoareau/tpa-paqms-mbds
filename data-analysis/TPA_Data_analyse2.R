...
clients <- read.csv("C:/Users/micha/Documents/MBDS/TPA/tpa-paqms-mbds/data-analysis/Clients_clean.csv", header = TRUE, sep = ",", dec = ".", stringsAsFactors = T)
...
features <- clients_immatriculations[, c("age", "taux", "nbEnfantsAcharge", "nbPlaces", "nbPortes", "prix")]
...
cluster_categories <- c("Electric", "Sportive", "Familiale", "Citadine", "Berline", "Compacte")
...
nouveaux_clients <- read.csv("C:/Users/micha/Documents/MBDS/TPA/tpa-paqms-mbds/data-analysis/Marketing.csv", header = TRUE, sep = ",", dec = ".", stringsAsFactors = T)
nouveaux_clients$Categorie <- predict(modele_C50, nouveaux_clients)

write.csv(nouveaux_clients, "C:/Users/micha/Documents/MBDS/TPA/tpa-paqms-mbds/data-analysis/Results.csv", row.names = FALSE)